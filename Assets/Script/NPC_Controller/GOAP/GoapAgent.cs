...
public sealed class GoapAgent : MonoBehaviour
{
    ...
    private FSM.FSMState idleState; // finds something to do (plans)
    private FSM.FSMState moveToState; // moves to a target if required to be in range
        ...
        performActionState = (fsm, gameObj) => {
            ...
            if (hasActionPlan()) {
                ...
                if ( inRange ) {
                    ...
                    bool success = action.performAction(gameObj);
